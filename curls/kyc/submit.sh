...
# Submit KYC documents with photo uploads
...
# 400 - KYC already submitted (use resubmit endpoint for rejected submissions)
...
# Photo Size Limit: 10MB per photo (decoded size)
